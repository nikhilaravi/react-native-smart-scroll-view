...
import React, { Component, PropTypes, View, TextInput, Text, StyleSheet, TouchableOpacity, Switch } from 'react-native';
...
const textFields = [
  ...
  { ref: 'mobile', keyboardType: 'phone-pad', placeholder: 'PHONE NUMBER', secureTextEntry: false, autoCapitalise: false },
  {
    ...
    placeholder: 'PASSWORD (6-9 LETTERS & AT LEAST 1 NO.)',
    ...
    return (
      <View style={styles.container}>
        <SmartScrollView
          ...
          {smartTexts}
          <View style={styles.ts_and_cs_container} smartScrollOptions={{ type: 'custom' }}>
          ...
          <View smartScrollOptions={{ type: 'custom', scrollRef: 'submitButton' }}>
            <Button onPress={submitContactInfo} text={'Continue'} />
          </View>
        </SmartScrollView>
      </View>
    );
