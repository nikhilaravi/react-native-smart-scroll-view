import React, { Component, View, TextInput, StyleSheet, Text, TouchableOpacity } from 'react-native';
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.headerText}>Super Scrolling Form</Text>
        </View>
        <SmartScrollView contentContainerStyle={styles.contentContainerStyle} forceFocusField={this.state.focusField} scrollPadding={10}>
          <TouchableOpacity style={styles.button} onPress={dismissKeyboard}>
            <Text style={styles.buttonText}>Example to remove keyboard with dismissKeyboard</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              this.setState({ focusField: 10 });
            }}>
            <Text style={styles.buttonText}>Example to force move to index 10</Text>
          </TouchableOpacity>
